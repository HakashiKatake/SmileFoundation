...
function y(){this.j=!1;this.h=null;this.m=void 0;this.g=1;this.v=this.l=0;this.i=null}
function z(a){if(a.j)throw new TypeError("Generator is already running");a.j=!0}
y.prototype.o=function(a){this.m=a};
function B(a,b){a.i={N:b,O:!0};a.g=a.l||a.v}
y.prototype.return=function(a){this.i={return:a};this.g=this.v};
...
function E(a){for(;a.g.g;)try{var b=a.h(a.g);if(b)return a.g.j=!1,{value:b.value,done:!1}}catch(c){a.g.m=void 0,B(a.g,c)}a.g.j=!1;if(a.g.i){b=a.g.i;a.g.i=null;if(b.O)throw b.N;return{value:b.return,done:!0}}return{value:void 0,done:!0}}
function ma(a){this.next=function(b){z(a.g);a.g.h?b=D(a,a.g.h.next,b,a.g.o):(a.g.o(b),b=E(a));return b};
...
r("Promise",function(a){function b(h){this.h=0;this.i=void 0;this.g=[];this.o=!1;var g=this.j();try{h(g.resolve,g.reject)}catch(k){g.reject(k)}}
...
var g=this,k=!1;return{resolve:h(this.I),reject:h(this.l)}};
b.prototype.I=function(h){if(h===this)this.l(new TypeError("A Promise cannot resolve to itself"));else if(h instanceof b)this.K(h);else{a:switch(typeof h){case "object":var g=h!=null;break a;case "function":g=!0;break a;default:g=!1}g?this.H(h):this.m(h)}};
b.prototype.H=function(h){var g=void 0;try{g=h.then}catch(k){this.l(k);return}typeof g=="function"?this.L(g,h):this.m(h)};
b.prototype.l=function(h){this.v(2,h)};
b.prototype.m=function(h){this.v(1,h)};
b.prototype.v=function(h,g){if(this.h!=0)throw Error("Cannot settle("+h+", "+g+"): Promise already settled in state"+this.h);this.h=h;this.i=g;this.h===2&&this.J();this.R()};
b.prototype.J=function(){var h=this;f(function(){if(h.S()){var g=q.console;typeof g!=="undefined"&&g.error(h.i)}},1)};
b.prototype.S=function(){if(this.o)return!1;var h=q.CustomEvent,g=q.Event,k=q.dispatchEvent;if(typeof k==="undefined")return!0;typeof h==="function"?h=new h("unhandledrejection",{cancelable:!0}):typeof g==="function"?h=new g("unhandledrejection",{cancelable:!0}):(h=q.document.createEvent("CustomEvent"),h.initCustomEvent("unhandledrejection",!1,!0,h));h.promise=this;h.reason=this.i;return k(h)};
b.prototype.R=function(){if(this.g!=null){for(var h=0;h<this.g.length;++h)e.h(this.g[h]);this.g=null}};
var e=new c;b.prototype.K=function(h){var g=this.j();h.A(g.resolve,g.reject)};
b.prototype.L=function(h,g){var k=this.j();try{h.call(g,k.resolve,k.reject)}catch(l){k.reject(l)}};
...
this.A(k(h,l),k(g,m));return u};
b.prototype.catch=function(h){return this.then(void 0,h)};
b.prototype.A=function(h,g){function k(){switch(l.h){case 1:h(l.i);break;case 2:g(l.i);break;default:throw Error("Unexpected state: "+l.h);}}
var l=this;this.g==null?e.h(k):this.g.push(k);this.o=!0};
b.resolve=d;b.reject=function(h){return new b(function(g,k){k(h)})};
b.race=function(h){return new b(function(g,k){for(var l=x(h),m=l.next();!m.done;m=l.next())d(m.value).A(g,k)})};
...
var w=[],A=0;do w.push(void 0),A++,d(k.value).A(u(w.length-1),m),k=g.next();while(!k.done)})};
return b});
...
function d(g,k){var l=k&&typeof k;l=="object"||l=="function"?e.has(k)?l=e.get(k):(l=""+ ++h,e.set(k,l)):l="p_"+k;var m=g[0][l];if(m&&F(g[0],l))for(g=0;g<m.length;g++){var u=m[g];if(k!==k&&u.key!==u.key||k===u.key)return{id:l,list:m,index:g,entry:u}}return{id:l,list:m,index:-1,entry:void 0}}
...
var e=new WeakMap;f.prototype.set=function(g,k){g=g===0?0:g;var l=d(this,g);l.list||(l.list=this[0][l.id]=[]);l.entry?l.entry.value=k:(l.entry={next:this[1],previous:this[1].previous,head:this[1],key:g,value:k},l.list.push(l.entry),this[1].previous.next=l.entry,this[1].previous=l.entry,this.size++);return this};
f.prototype.delete=function(g){g=d(this,g);return g.entry&&g.list?(g.list.splice(g.index,1),g.list.length||delete this[0][g.id],g.entry.previous.next=g.entry.next,g.entry.next.previous=g.entry.previous,g.entry.head=null,this.size--,!0):!1};
f.prototype.clear=function(){this[0]={};this[1]=this[1].previous=b();this.size=0};
f.prototype.has=function(g){return!!d(this,g).entry};
f.prototype.get=function(g){return(g=d(this,g).entry)&&g.value};
...
c.prototype=b.prototype;a.G=b.prototype;a.prototype=new c;a.prototype.constructor=a;a.X=function(d,f,e){for(var h=Array(arguments.length-2),g=2;g<arguments.length;g++)h[g-2]=arguments[g];return b.prototype[f].apply(d,h)}}
...
J.prototype.i=!1;J.prototype.dispose=function(){this.i||(this.i=!0,this.B())};
...
var Ua=[L("data"),L("http"),L("https"),L("mailto"),L("ftp"),new Ta(function(a){return/^[^:]*([/?#]|$)/.test(a)})],Va=/^\s*(?!javascript:)(?:[\w+.-]+:|[^:/?#]*(?:[/?#]|$))/i;var Wa={W:0,U:1,V:2,0:"FORMATTED_HTML_CONTENT",1:"EMBEDDED_INTERNAL_CONTENT",2:"EMBEDDED_TRUSTED_EXTERNAL_CONTENT"};function M(a,b){b=Error.call(this,a+" cannot be used with intent "+Wa[b]);this.message=b.message;"stack"in b&&(this.stack=b.stack);this.type=a;this.name="TypeCannotBeUsedWithIframeIntentError"}
var N=Error;M.prototype=fa(N.prototype);M.prototype.constructor=M;if(ja)ja(M,N);else for(var O in N)if(O!="prototype")if(Object.defineProperties){var Xa=Object.getOwnPropertyDescriptor(N,O);Xa&&Object.defineProperty(M,O,Xa)}else M[O]=N[O];M.G=N.prototype;function Ya(a){Ra.test(a)&&(a.indexOf("&")!=-1&&(a=a.replace(La,"&amp;")),a.indexOf("<")!=-1&&(a=a.replace(Ma,"&lt;")),a.indexOf(">")!=-1&&(a=a.replace(Na,"&gt;")),a.indexOf('"')!=-1&&(a=a.replace(Oa,"&quot;")),a.indexOf("'")!=-1&&(a=a.replace(Pa,"&#39;")),a.indexOf("\x00")!=-1&&(a=a.replace(Qa,"&#0;")));return a}
...
;function T(a){J.call(this);this.o=1;this.l=[];this.m=0;this.g=[];this.h={};this.v=!!a}
ta(T,J);n=T.prototype;n.subscribe=function(a,b,c){var d=this.h[a];d||(d=this.h[a]=[]);var f=this.o;this.g[f]=a;this.g[f+1]=b;this.g[f+2]=c;this.o=f+3;d.push(f);return f};
function ib(a,b,c){var d=U;if(a=d.h[a]){var f=d.g;(a=a.find(function(e){return f[e+1]==b&&f[e+2]==c}))&&d.C(a)}}
n.C=function(a){var b=this.g[a];if(b){var c=this.h[b];this.m!=0?(this.l.push(a),this.g[a+1]=function(){}):(c&&wa(c,a),delete this.g[a],delete this.g[a+1],delete this.g[a+2])}return!!b};
...
function wb(a){U.F.apply(U,arguments)}
...
n.destroy=function(){this.g&&this.g.id&&(V[this.g.id]=null);var a=this.j;a&&typeof a.dispose=="function"&&a.dispose();this.i?hb(this.i,this.g):(a=this.g)&&a.parentNode&&a.parentNode.removeChild(a);Z&&(Z[this.id]=null);this.options=null;this.g&&this.o&&this.g.removeEventListener("load",this.o);this.i=this.g=null};
...
n.D=function(){this.g&&this.g.contentWindow?this.sendMessage({event:"listening"}):clearInterval(this.h)};
...
function Kb(a,b){b=x(b);for(var c=b.next(),d={};!c.done;d={s:void 0},c=b.next())d.s=c.value,a[d.s]||(d.s==="getCurrentTime"?a[d.s]=function(){var f=this.playerInfo.currentTime;if(this.playerInfo.playerState===1){var e=(Date.now()/1E3-this.playerInfo.currentTimeLastUpdated_)*this.playerInfo.playbackRate;e>0&&(f+=Math.min(e,1))}return f}:xb(d.s)?a[d.s]=function(f){return function(){this.playerInfo={};
this.u={};Fb(this,f.s,arguments);return this}}(d):yb(d.s)?a[d.s]=function(f){return function(){var e=f.s,h=0;
e.search("get")===0?h=3:e.search("is")===0&&(h=2);return this.playerInfo[e.charAt(h).toLowerCase()+e.substring(h+1)]}}(d):a[d.s]=function(f){return function(){Fb(this,f.s,arguments);
return this}}(d))}
...
function Hb(a,b,c){Z||(Z={},Lb=new Set,Nb.addEventListener("message",function(d){a:if(Lb.has(d.origin)){try{var f=JSON.parse(d.data)}catch(g){break a}var e=Z[f.id];if(e&&d.origin===e.M)switch(d=e.T,d.m=!0,d.m&&(va(d.l,d.sendMessage,d),d.l.length=0),e=f.event,f=f.info,e){case "apiInfoDelivery":if(H(f))for(var h in f)f.hasOwnProperty(h)&&(d.u[h]=f[h]);break;case "infoDelivery":Jb(d,f);break;case "initialDelivery":H(f)&&(clearInterval(d.h),d.playerInfo={},d.u={},Kb(d,f.apiInterface),Jb(d,f));break;default:d.j.i||
(h={target:d,data:f},d.j.F(e,h),wb("player."+e,h))}}}));
Z[b]={T:a,M:c};Lb.add(c)}
